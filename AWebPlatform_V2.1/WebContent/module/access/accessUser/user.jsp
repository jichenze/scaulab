...
<div class="gutter-bottom">
	<button id="userCreBtn" type="button"
	...
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><a id="userDelBtn" class="hvr-bounce-to-left disabled"
				href="javascript:"><i class="fa fa-trash"></i>删除</a></li>
			<li><a id="userUpdBtn" class="hvr-bounce-to-left disabled"
				href="javascript:"><i class="fa fa-edit"></i>编辑</a></li>
			<li><a id="userRoleBtn" class="hvr-bounce-to-left disabled"
				href="javascript:"><i class="fa fa-user"></i>配置角色</a></li>
			<li><a id="unlockuserBtn" class="hvr-bounce-to-left disabled"
				href="javascript:"><i class="fa fa-unlock-alt"></i>解除锁定</a></li>
		</ul>
	</div>
</div>
<%--用户操作部分 End--%>
...
<div>
	...
	<div class="tips-table">
		<span>* 提示：可通过</span> <span class="tips-table-key">“单击”</span> <span>来修改配置角色。</span>
		</br> <span>* 提示：删除、编辑、配置角色按钮需要</span> <span class="tips-table-key">“选中对应用户”</span>
		<span>才能使用。</span>
	</div>
</div>
<%--用户表格 End--%>
...
<div id="userCreTemp" class="hide">
	<div class="control-group">
		...
		<div class="controls">
			<input id="username" name="username" type="text" placeholder="用户名"
				class="span8"> <span id="usernameTips"
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="nickname" name="nickname" type="text" placeholder="昵称"
				class="span8"> <span id="nikenameTips"
				class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input id="mailbox" name="mailbox" type="text" placeholder="邮箱"
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="telephone" name="telephone" type="text" placeholder="手机"
				class="span8"> <span class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
...
<div id="userEditTemp" class="hide">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="editnickname" name="nickname" type="text" placeholder="昵称"
				class="span8"> <span id="editnicknameTips"
				class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input id="editpassword" data-inner-switcher="true"
				name="initPassword" type="checkbox" /> <span style="color: #b94a48;">初始密码为：111111</span>
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="editmailbox" name="mailbox" type="text" placeholder="邮箱"
				class="span8"> <span class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input id="edittelephone" name="telephone" type="text"
				placeholder="手机" class="span8"> <span
				class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
...
<%--关联角色 Temp Start--%>
<div id="userRoleTemp" class="modal fade hide modal-lg" tabindex="-1"
	...
	<div class="modal-body">
		<table id="userRoleTb" class="display dataTable table"
			style="width: 100%;">
			<colgroup>
				<col width="5%" />
				<col width="10%" />
