...
<style type="text/css">
    ...
    <div class="gutter-bottom">
        <button id="roleCreBtn" type="button" class="btn btn-inverse hvr-radial-out">
            <i class="fa fa-plus"></i>&nbsp;创建
        </button>
        <button id="roleAccessBtn" type="button" class="btn btn-inverse hvr-radial-out disabled">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a id="roleDelBtn" class="hvr-bounce-to-left disabled" href="javascript:"><i class="fa fa-trash"></i>删除</a></li>
                <li><a id="roleUpdBtn" class="hvr-bounce-to-left disabled" href="javascript:"><i class="fa fa-edit"></i>编辑</a></li>
            </ul>
        </div>
    </div>
    <%--用户操作部分 End--%>
    ...
    <div>
        ...
        <div class="tips-table">
		       <span>* 提示：可通过</span>
		       <span class="tips-table-key">“双击”</span>
		       <span>来修改角色对应的权限。</span>
		       </br>
		       <span>* 提示：删除、编辑、配置权限按钮需要</span>
    ...
    <div id="roleCreTemp" class="hide">
        <div class="control-group">
            ...
            <div class="controls">
                <input id="rolename" name="rolename" type="text" placeholder="用户名" class="span8">
        ...
        <div class="control-group">
			...
			<div class="controls">
                <input id="state" name="state" data-inner-switcher="true" type="checkbox" />
            </div>
        </div>
        <div class="control-group">
    ...
    <div id="roleEditTemp" class="hide">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="editrolename" name="rolename" type="text" placeholder="用户名" class="span8" disabled>
                <span class="help-inline hide"></span>
            </div>
        </div>
