	...
	<div data-role="" class="system-invoices-cct">
		...
		<div class="ech-ctt-footer row-fluid">
			<div class="ech-attr span12">
				<span data-role="echMiddle" class="echMiddle">0</span> <br />事件总数
			</div>
			<div class="ech-attr span12">
				<span data-role="echSystem" class="echSystem">0</span> <br />已处理事件数
			</div>
			<div class="ech-attr span12">
				<span data-role="echSql" class="echSql">0</span><br /> 未处理事件数
			</div>
		</div>
	</div>
	<div data-role="" class="system-invoices-cct">
...
<div class="system-module">
	<div style="padding-top: 10px; margin-left: 10px;">
		事件名：<input type="text" class="system-common-input"
		...
		事件状态：<select style="width: 100px;"><option>告警</option>
			<option>预警</option></select>
		<button data-role="eventBtn"
