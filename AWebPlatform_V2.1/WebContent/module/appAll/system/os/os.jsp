...
<!-- 事件详情start -->
<div data-role="echartsDtlTemp"
	class="modal fade hide sltModal modal-lg" tabindex="-1" role="dialog"
	...
	<div class="modal-body">
		<div data-role="echartsDtlCtn"></div>
	</div>
	<div class="modal-footer">
		<button class="btn" data-dismiss="modal" aria-hidden="true"
			data-role="deleteBtn">取消</button>
	</div>
</div>
<!-- 事件详情end -->
<!-- start-->
