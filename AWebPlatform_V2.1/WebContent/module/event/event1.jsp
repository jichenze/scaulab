...
<div class="event-module" style="width: 95%">
	<div style="padding-top: 10px; margin-left: 10px;">
		事件名：<input type="text" id="eventName1" class="event-common-input"
			placeholder="请输入事件名..." /> 起始时间：
		<div class="input-append date form_datetime" data-date="">
			<input size="8" type="text" id="startTime1" value="" readonly
		...
		结束时间：
		<div class="input-append date form_datetime" data-date="">
			<input size="8" type="text" id="endTime1" value="" readonly
				class="form_datetime-input" placeholder="请输结束日期..."> <span
				class="add-on"><i class="icon-remove"></i></span> <span
				class="add-on"><i class="icon-calendar"></i></span>
		</div>
		事件状态：<input type="text" id="eventState1" placeholder="请输入事件状态..."
			class="event-common-input" />
		<button data-role="eventBtn" id="eventBtn1"
...
<div class="event-change"
	...
	<span style="text-align: center;">
		<button type="button" id="change2" class="btn btn-large btn-circle"
