...
<div class="gutter-bottom">
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><a id="reviewUpdBtn" class="hvr-bounce-to-left disabled"
				href="javascript:"><i class="fa fa-edit"></i>审核</a></li>
		</ul>
	</div>
</div>
<%--操作部分 End--%>
<%--使用申请单表格 Start--%>
<div>
	<table id="reviewTb" class="display dataTable table"
		style="width: 100%;">
		<colgroup>
			<col width="3%" />
			<col width="10%" />
...
<div id="reviewTemp" class="hide">
	<div class="control-group">
		...
		<div class="controls">
			<input id="syname" name="syname" type="text" placeholder="申请人"
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="sypid" name="sypid" type="text" placeholder="学号/工号"
				class="span8" disabled> <span class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input id="synumber" name="synumber" type="text" placeholder="联系方式"
				class="span8" disabled> <span class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input id="sywpname" name="sywpname" type="text" placeholder="申购物品名称"
				class="span8" disabled> <span class="help-inline hide"></span>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="syjldw" name="syjldw" type="text" placeholder="申请数量"
				class="span8" disabled>
		</div>
	</div>
	<div class="control-group">
	...
	<div>
		<label class="radio inline "> <input type="radio" name="syyn"
			id="cgyn1" value="yes" checked> 通过
		</label> <label class="radio inline"> <input type="radio" name="syyn"
			id="cgyn2" value="no"> 不通过
		</label>
	</div>
