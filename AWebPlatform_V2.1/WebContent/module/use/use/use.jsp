...
<%@ page session="false"%>
 <%--操作部分 Start--%>
    <div class="gutter-bottom">
     	<button id="useCreBtn" type="button" class="btn btn-inverse hvr-radial-out">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a id="useUpdBtn" class="hvr-bounce-to-left disabled" href="javascript:"><i class="fa fa-edit"></i>查看</a></li>               
            </ul>
        </div>
    </div>
    <%--操作部分 End--%>
 ...
 <%--发放界面 Temp Start--%>
    ...
    <div id="uesTempcrt" class="hide">
        <div class="control-group">
            ...
            <div class="controls">
                <input id="cgname" name="cgname"  type="text" placeholder="申请人" class="span8" >
                <span  class="help-inline hide"></span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="cgpid">学号/工号：</label>
            <div class="controls">
                <input id="cgpid" name="cgpid" type="text" placeholder="学号/工号" class="span8">
                <span class="help-inline hide"></span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="cgnumber">联系方式：</label>
            <div class="controls">
                <input id="cgnumber" name="cgnumber" type="text" placeholder="联系方式" class="span8">
                <span class="help-inline hide"></span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="cgwpname">物品名称：</label>
            <div class="controls">
                <input id="cgwpname" name="cgwpname" type="text" placeholder="领用物品名称" class="span8">
                <span class="help-inline hide"></span>
            </div>
        </div>
         <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="cgwpsl" name="cgwpsl" type="text" placeholder="数量" class="span8" >
            </div>
        </div>
         <div class="control-group">
            <label class="control-label" for="cgwpsl">计量单位：</label>
