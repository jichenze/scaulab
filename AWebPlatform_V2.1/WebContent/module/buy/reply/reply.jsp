...
<div class="gutter-bottom">
	<div class="btn-group">
		...
		<ul class="dropdown-menu">
			<li><a id="replyUpdBtn" class="hvr-bounce-to-left disabled"
...
<%--申请单表格 Start--%>
<div>
	<table id="replyTb" class="display dataTable table"
		style="width: 100%;">
		<colgroup>
			<col width="3%" />
			<col width="2%" />
...
<div id="replyTemp" class="hide">
	<div class="control-group">
		...
		<div class="controls">
			<input id="cgid" name="cgid" type="text" placeholder="时间"
	...
	<div>
		<label class="radio inline "> <input type="radio" name="cgyn"
			id="cgyn1" value="yes" checked> 通过
		</label> <label class="radio inline"> <input type="radio" name="cgyn"
	...
	<div class="showpass">
		<div class="control-group">
			...
			<div class="controls">
				<input id="cgdate" name="cgdate" type="datetime" readonly=""
					placeholder="请选择时间" class="span8 form_datetime"> <span
					class="help-inline hide">请选择时间</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="cgpl">采购批量：</label>
			<div class="controls">
				<input id="cgpl" name="cgpl" type="text" placeholder="采购批量"
