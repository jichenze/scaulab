...
<div id="defCtn" class="def-ctn row">
	<div id="defCtt" class="def-ctt span10">
		<div id="defAddBox" class="def-item-box well">
			<a href="#defModal" data-toggle="modal"
				class="def-item-add-btn fa fa-plus"></a>
		</div>
	...
	<div id="_id_" data-role="defCtt" class="def-ctt span10">
		<div data-role="defItemBox" class="def-item-box well">
			<div data-role="defTip" class="def-tip ">
				<span data-role="defTipShare" data-toggle="modal"
					class="def-tip-icon fa fa-share-alt"></span> <span
					data-role="defTipDel" class="def-tip-icon fa fa-trash"></span>
			</div>
		</div>
		<div data-role="defItem1" class="def-item row">
			<div data-role="defItemName" class="def-item-name span6 offset2">
				_name_</div>
			<span data-role="defItemNameEdit"
				class="def-item-edit-btn fa fa-edit span2"></span>
		</div>

		<div data-role="defItem2" class="def-item row hide">
			<div class="def-item-name span6">
				<input type="text" data-role="defItemInput" class="def-item-input">
			</div>
			<div data-role="defItem2Edit" class="span4">
				<span data-role="defItemNameEditX"
					class="def-item-edit-btn fa fa-times-circle"></span>&nbsp; <span
					data-role="defItemNameEditOK" class="def-item-edit-btn fa fa-check"></span>
			</div>
		</div>
...
<div id="defModal" class="modal fade hide">
	...
	<div id="defModalBody" class="modal-body row"></div>
	<div class="modal-footer">
		<i class="btn" data-dismiss="modal">取消</i> <i id="itemNameSubmit"
			class="btn btn-info">完成</i>
	</div>
</div>
<%--编辑项目信息模态框End --%>
...
<div data-role="defItemMenuTemp" class="hide">
	<label class="def-item-config"> 项目名称&nbsp;:&nbsp;&nbsp;&nbsp; <input
		data-role="defItemNameInput" type="text" class="span12" autofocus>
	</label>
</div>
<%--编辑 菜单模态框内容模板Start --%>
...
<%--编辑 分享模态框内容模板Start --%>
<div id="defItemShareTemp" class="hide"></div>
<%--编辑 分享模态框内容模板Start --%>
