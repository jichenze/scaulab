...
<%--操作部分 Start --%>
    <div class="gutter-bottom">
        <button id="dangerCreBtn" type="button" class="btn btn-inverse hvr-radial-out">
...
<%--     存储表格 Start --%>
    <div>
        <table id="dangerTb" class="display dataTable table" style="width:100%;">
            <colgroup>
                <col width="3%"/>
                <col width="10%"/>
                <col width="20%"/>
            ...
            <thead>
            <tr>
               <th><input id="dangerSelAllBtn" type="checkbox"/></th>
               <th>名称</th>
		      <th>存储地点</th>
		      <th>入库时间</th>
		      <th>入库量</th>
 ...
 <%--创建界面 Temp Start --%>
    <div id="dangerTemp" class="hide">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="ghtime" name="ghtime" type="text" class="span8">
                <span class="help-inline hide"></span>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input id="ghpn" name="ghpn" type="text"  class="span8">
                <span class="help-inline hide"></span>
            </div>
        </div>
