...
<button id="creatgeneral" type="button" data-role="generalview" class="btn btn-success pull-right">创建</button>

<button type="button" class="btn btn-danger" data-toggle="collapse" data-target="#demo-general">详细列表</button>
 
<div id="demo-general" class="collapse in">
	<div class="accordion" id="accordion2">
		  <div class="accordion-group">
		    <div class="accordion-heading">
		      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne-general">
		        XX1存储信息
		      </a>
		    </div>
		    <div id="collapseOne-general" class="accordion-body collapse in">
		  ...
		  <div class="accordion-group">
		    <div class="accordion-heading">
		      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo-general">
		        XX2存储信息
		      </a>
		    </div>
		    <div id="collapseTwo-general" class="accordion-body collapse">
		      <div class="accordion-inner">
		        <div class=row>
		      	 	 <div class="span6">
		       		 	<h4>名称：</h4>
 ...
 <!--创建新的存储信息-->
<div id="generalview" class="modal fade hide modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
