                     ...
                     if(data.status&&data.content){
                         for(items=data.content.ccData,i=items.length;(item=(items[--i]));) {
                             dealData.push([
                                 ...
                                 item.cunchu_name,
                                 item.cunchu_lx=="1"?"有毒": item.cunchu_lx=="3"?"低值品":"普通",
                                 item.cunchu_liang,
                                 item.cunchu_jldw,
                                 item.cunchu_dw,
                                 item.cunchu_dd,
                             ...
                             dizhiData[item.cunchu_name] = item;
                         }
                     }else {
...
//            /*函数定义*/
//            handler.fn = {
//                    dizhiCreCallback: function (context, $ele) {              
//                            $("#dizhiBtn").click(function(){
//                            	 $.ajax({
//                                     "type": "post",
//                                     "contentType": "application/x-www-form-urlencoded;charset=utf-8",
...
//                    //设置创建用户表单
//                    app.formControl
//                        .set('创建存储信息', $('#dizhiTemp').html(), handler.fn.dizhiCreCallback)
//                        .show();
//                },
//            });
//            
