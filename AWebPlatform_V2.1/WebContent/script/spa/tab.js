        ...
        var Label = function () {
            ...
            function focusTab($tab, $btn) {
                var widths = 0,
                    ...
                    $tabBtn = $btn || $('#tabsLeft'),
                    tabsContainerWidth = $('#tabsContainer').innerWidth() - $tabBtn.outerWidth() *4.2,
                ...
                if(tabsContainerWidth-widths>tabsOffsetLeft){
                    ...
                    //偏左超界
                    tabsOffsetLeft=tabsOffsetLeft>5?5:tabsOffsetLeft;
                }
            ...
            this.close=function(id){
                if(!closeTimeout) {
                    ...
                    } else if (($tab = $tabs.children('[data-href="' + id + '"]')).length) {
                        app.alert('页面错误',
